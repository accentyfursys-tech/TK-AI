...
try:
    ...
    # ============================================================
    # 1. 엑셀피봇(표1): 행=채산계정3, 열=팀세부, 필터=직접간접/채산계정1/채산계정2
    # ============================================================
    # 채산피봇 시트 뒤에 추가
    after_sheet = wb.sheets['채산피봇']
    s2 = wb.sheets.add('엑셀피봇(표1)', after=after_sheet)
